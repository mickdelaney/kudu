...
var Process = (function () {
    ...
    Process.prototype.tableRow = function (level) {
        ...
        tr.appendChild(Utilities.ToTd(Utilities.commaSeparateNumber(this._json.working_set / 1024)));
        tr.appendChild(Utilities.ToTd(Utilities.commaSeparateNumber(this._json.private_memory / 1024)));
        tr.appendChild(Utilities.ToTd(Utilities.commaSeparateNumber(this._json.thread_count / 1024)));
